        ...
        <div class="b">Thông tin tài khoản</div>
         @if(session('success'))
             <p style="color:green">{{session('success')}}</p>
                         @endif
   <form action="hocvien/capnhat" method="POST" enctype="multipart/form-data">
     {{ csrf_field() }}
              ...
              <br>
               <div class="b">Thông tin học viên</div>

                <div class="form-group field-users-ho_ten required">
<label class="control-label" for="users-ho_ten">Họ tên</label><br>
<input type="text" id="users-ho_ten" class="form-control" name="hoten" maxlength="150" placeholder="Nguyễn Văn A" value="{{$nguoidung->HoTenHocVien}}">
...
<option value="Nam"<?php  if($nguoidung->GioiTinh=='Nam') echo "selected";?>>Nam</option>
<option value="Nữ" <?php if($nguoidung->GioiTinh=='Nữ') echo "selected";?>>Nữ</option>
</select>
...
<input type="date" id="users-dia_chi" class="form-control" name="ngaysinh" value="{{$nguoidung->NgaySinh}}">
...
<div class="help-block">@if($errors->has('ngaysinh'))
 ...
 <div class="form-group field-users-dia_chi required">
<label class="control-label" for="users-dia_chi">CMND</label><br>
<input type="text" id="users-dia_chi" class="form-control" name="cmnd" value="{{$nguoidung->CMND}}">
...
<div class="help-block">@if($errors->has('cmnd'))
 ...
 <div class="form-group field-users-dia_chi required">
<label class="control-label" for="users-dia_chi">Ngày cấp</label><br>
<input type="date" id="users-dia_chi" class="form-control" name="ngaycap" value="{{$nguoidung->NgayCap}}">
...
<input type="text" id="users-dien_thoai" class="form-control" name="dienthoai" maxlength="11" placeholder="0123456789" value="{{$nguoidung->SDT}}">
...
<input type="text" id="users-email" class="form-control" name="email" maxlength="50" placeholder="myemail@gmail.com" value="{{$nguoidung->Email}}">
...
<div class="help-block">@if($errors->has('email'))
 ...
 <div class="form-group field-users-dia_chi required">
<label class="control-label" for="users-dia_chi">Nghề nghiệp</label><br>
<input type="text" id="users-dia_chi" class="form-control" name="nghenghiep" value="{{$nguoidung->NgheNghiep}}" >
...
<input type="text" id="users-dia_chi" class="form-control" name="diachi" maxlength="250" placeholder="01 Phạm Ngọc Thạch, P6, Q3, HCM" value="{{$nguoidung->DiaChi}}">
