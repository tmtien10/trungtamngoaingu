...
@section('breadcrumb')
							...
							<li><a href="ad/khoahoc/danhsach">Danh sách khóa học</a> </li>
...
@section('content')
					...
					<div class="page-header">
                      ...
                      <form  role="form" action="ad/khoahoc/sua/{{$khoahoc->MaKhoa}}" method="POST">
             {{ csrf_field() }}
             <div class="form-group">
                              
                                <label>Mã khóa học</label>
                              
                                <input class="form-control" name="MaKhoa"  value="{{$khoahoc->MaKhoa}}"  readonly="">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="TenKhoaHoc" placeholder="Nhập tên khóa học" value="{{$khoahoc->TenKhoaHoc}}" >
    <p class="help-block col-xs-12 col-sm-reset inline">
            @if($errors->has('TenKhoaHoc'))
                      <p style="color:red">{{$errors->first('TenKhoaHoc')}}</p>
                          @endif</p>
                                 </div>
                                ...
                                <select name="Nam">
								  ...
								  <option value="{{$khoahoc->Nam}}">{{$khoahoc->Nam}}</option>
