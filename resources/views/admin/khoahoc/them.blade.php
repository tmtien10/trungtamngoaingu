...
@section('content')
                    ...
                    <div class="col-lg-7" style="padding-bottom:120px">
                        ...
                        <form action="ad/khoahoc/them" method="POST">
                            {{ csrf_field() }}
                            <div class="form-group">
                              
                                <label>Tên khóa học</label>
                              
                                <input class="form-control" name="TenKhoaHoc" placeholder="Nhập tên khóa học" value="" />
    <p class="help-block col-xs-12 col-sm-reset inline">
            @if($errors->has('TenKhoaHoc'))
                    ...
                    <br>
                            ...
                            <button class="btn" type="reset" class="btn btn-default"><i class="ace-icon fa fa-undo bigger-110"></i>Làm mới</button>
                            </div>
                            </div>
