...
@section('breadcrumb')
							...
							<li class="active">Thêm phòng học</li>
@endsection
@section('content')
					...
					<form class="form-horizontal" action="ad/phonghoc/them" method="POST"  enctype="multipart/form-data">
						   {{ csrf_field() }}
						
						<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Tên phòng học</span></label>
											<div class="col-sm-9">
													<input class="col-xs-10 col-sm-5" id="form-field-mask-2" type="text" name="MaPhongHoc">	<br><p class="help-block col-xs-12 col-sm-reset inline">
						...
						<div class="form-group">
											...
											<div class="col-sm-9">
													<select class="col-xs-10 col-sm-5" name="KhuVuc" id="">	
														...
														<option value="{{$kv->MaKhuVuc}}">{{$kv->MaKhuVuc}}</option>
														@endforeach		
													</select>			
											</div>
						</div>
