...
@section('title','Duyệt phiếu đăng kí học')
@section('css')
...
@section('content')
					...
					<div class="page-header">
							<h1>
								Thông tin phiếu đăng kí
											...
											<!-- PAGE CONTENT BEGINS -->
											<form action="ad/phieudangki/sua" method="POST">
						{{ csrf_field() }}
					...
					<div class="col-sm-10 col-sm-offset-1">
							...
							?>
														...
														<div class="col-sm-6">
															...
															<div>
																...
																<ul class="list-unstyled spaced">
																	...
																	<li>
																		<i class="ace-icon fa fa-caret-right blue"></i>Ngày bắt đầu: {{$lopdk->NgayKhaiGiang}}
																	</li>

																	<li>
																		<i class="ace-icon fa fa-caret-right blue"></i>Ngày kết thúc: {{$lopdk->NgayKetThuc}}
																	</li>
									...
									<center>	<button name='duyet' value="{{$phieu->id_PhieuDKHoc}}"class="btn btn-info" type="submit">Duyệt và tạo hóa đơn</button>
