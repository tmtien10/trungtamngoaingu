...
@section('content')
					...
					<form class="form-horizontal" role="form" action="ad/nhom/chianhom" method="POST">
						 {{ csrf_field() }}
						
						
						<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Mã Lớp   </label>

										<div class="col-sm-9">
												<select class="col-xs-10 col-sm-5" name="LopHoc" id="lop">	
						...
						<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Ngày khai giảng  </label>

										<div class="col-sm-9">
												<select class="col-xs-10 col-sm-5" name="ngkhaigiang" id="ngkhaigiang" value={{old('ngkhaigiang')}} >	
													</select>	
						...
						<div class="form-group">
											...
											<div class="col-sm-9">
												<select class="col-xs-10 col-sm-5" name="SLHocVien" id="">	
...
$(document).ready(function(){
 ...
 $(document).on('change', '#lop', function(e){
      e.preventDefault();
      $.ajaxSetup({
              headers: {
