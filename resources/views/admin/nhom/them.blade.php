...
@section('content')
					...
					<form class="form-horizontal" role="form" action="ad/nhom/them" method="POST">
						 {{ csrf_field() }}
  ...
  <br />
   <h4 align="center">Thời Khóa Biểu</h4>
   <br />
...
$(document).ready(function(){
 ...
 $(document).on('click', '.add', function(){
  ...
  html += '<td><select name="ThoiGian[]" class="form-control item_unit"><?php 
   ...
   ?></select></td>';
  html += '<td><select name="TietHoc[]" class="form-control item_unit"><?php 

    foreach($tiethoc as $tiethoc){
      echo '<option value="'.$tiethoc->id_TietHoc.'">'.$tiethoc->ThoiGianBD.'/'.$tiethoc->ThoiGianKT.'</option>';
    }
