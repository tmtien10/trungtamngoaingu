...
@section('content')
        <div class="page-header">
                        ...
                        <div class="clearfix">
                        <center><form method="POST" action="ad/thongke/tk">
                                {{ csrf_field() }}
                            <select name="thongke" id="thongke">
                                <option value="1">Kì thi</option>
                                <option value="2">Kết quả thi</option>
                                <option value="3">Khóa học</option>
                                <option value="4">Giảng viên</option>
                            </select>
                            <select name="macc" id="dieukien"></select>
                            <input type="hidden" name="nam" id="nam" class="date-picker-year">
...
<link rel="stylesheet" href="//code.jquery.com/ui/1.11.4/themes/smoothness/jquery-ui.css">
  ...
  <style>
    ...
    <script type="text/javascript">
            ...
            $(document).on("change",'#thongke',function(e){
                e.preventDefault();
            var s=$('#thongke').val()
      ...
      $.ajax({
          ...
          success: function (data) {
            ...
            $.each(data, function(key, value){
               $("#dieukien").append('<option value="' + value.ma + '">' + value.ten + '</option>');
