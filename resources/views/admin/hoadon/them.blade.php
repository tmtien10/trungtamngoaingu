...
@section('content')
					...
					<div class="page-header">
							<h1>
								Thông tin hóa đơn
											...
											<!-- PAGE CONTENT BEGINS -->
											<form action="ad/hoadonhoc/them" method="POST">
						{{ csrf_field() }}
					...
					<div class="col-sm-10 col-sm-offset-1">
							...
							?>
									...
									<?php
									$lopkm=DB::table('lopkhoa')->where('id',$lopdk->id)->select('MaLop')->first();
									...
									?>
															<tbody>
																<tr>
																	...
																	<td><a href="ad/lophoc/sua/{{$lopdk->MaLop}}">{{$lopdk->TenLop}} </a></td>
																	<td>
																		{{date('d-m-Y')}}
																	</td>
																	<td class="hidden-xs">
																		{{number_format($lopdk->HocPhi,0,'.','.')}}
																	</td>
																	<td class="hidden-480">{{number_format($giam,0,'.','.')}}</td>
																	<td class="hidden-480">{{number_format($lopdk->HocPhi-$giam,0,'.','.')}}</td>
													...
													<div class="row">
														<div class="col-sm-5 pull-right">
															<h4 class="pull-right">
																Tổng cộng :
																<span class="red">{{number_format($lopdk->HocPhi-$giam,0,'.','.')}} VND</span>
															</h4>
														</div>
									...
									<center>	<button name='duyet' value="{{$phieu->id_PhieuDKHoc}}"class="btn btn-info" type="submit">Tạo hóa đơn</button>
