...
@section('breadcrumb')
							...
							<li><a href="ad/st">Danh sách môn học</a> </li>
...
@section('content')
					...
					<form class="form-horizontal" role="form" action="ad/monhoc/sua/{{$monhoc->MaMonHoc}}" method="POST">
							 {{ csrf_field() }}
						
					
						<div class="form-group">
											<label class="col-sm-2 control-label no-padding-right" for="form-field-1">Tên môn học</label>
											<div class="col-sm-9">
													<input class="col-xs-10 col-sm-5" id="form-field-mask-2" type="text" name="TenMonHoc" value="{{$monhoc->TenMonHoc}}">
						...
						<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right" for="form-field-1">Giới Thiệu</label>
											<div class="col-sm-9">
													<textarea name="GioiThieu" id="" class="form-control ckeditor" rows="5" value="{{$monhoc->GioiThieu}}">{{$monhoc->GioiThieu}}</textarea>
