...
@section('content')
					...
					<form class="form-horizontal" role="form" action="ad/monhoc/them" method="POST">
						{{ csrf_field() }}
						
						<div class="form-group">
											<label class="col-sm-2 control-label no-padding-right" for="form-field-1">Tên môn học</label>
											<div class="col-sm-9">
													<input class="col-xs-10 col-sm-5" id="form-field-mask-2" type="text" name="TenMonHoc">
													<br>
								<p class="help-block col-xs-12 col-sm-reset inline">
            @if($errors->has('TenMonHoc'))
                      <p style="color:red">{{$errors->first('TenMonHoc')}}</p>
                          @endif</p>
											</div>
						</div>
						...
						<div class="form-group">
											...
											<div class="col-sm-9">
													<textarea name="GioiThieu" id="" rows="3" cols="140" class="ckeditor"></textarea><br>
											<p class="help-block col-xs-12 col-sm-reset inline">
